    ...
    return (
        <section className='"container mx-auto mt-[130px] max-md:px-[30px] px-[55px] '>
            <div>
                ...
                <div className='flex justify-between items-center max-md:flex-col max-md:gap-10 mt-20 max-md:ml-6'>
                    <div className='md:w-[592px]'>
                        <h1 className='text-[55px] md:text-[62px] text-[#7D4283] leading-[75px] tracking-[-3%] font-[500] mb-6'>We bear the responsibility of developing the sector.</h1>
                        <p className='text-[20px] md:text-[24px] text-[#646A69] font-[300] leading-[36px] tracking-[-3%]'>
                    ...
                    <div className=' flex flex-wrap md:flex-col gap-16 md:w-[400px]'>
                        <div>
                            <h1 className='text-[48px] text-[#FFFFFF] font-[600] leading-[60px] tracking-[-3%]'>1,200+</h1>
                            <p className='text-[18px] text-[#646A69] font-[500] leading-[26px] tracking-[-0.4%]'>Clients</p>
                        </div>
                        <div>
                            <h1 className='text-[48px] text-[#FFFFFF] font-[600] leading-[60px] tracking-[-3%]'>20+</h1>
                            <p className='text-[18px] text-[#646A69] font-[500] leading-[26px] tracking-[-0.4%]'>Branches</p>
                        </div>
                        <div>
                            <h1 className='text-[48px] text-[#FFFFFF] font-[600] leading-[60px] tracking-[-3%]'>200+</h1>
                            <p className='text-[18px] text-[#646A69] font-[500] leading-[26px] tracking-[-0.4%]'>Number of Employees</p>
                        </div>
                        <div>
                            <h1 className='text-[48px] text-[#FFFFFF] font-[600] leading-[60px] tracking-[-3%]'>315+</h1>
